...
public class HttpClientTool {
    ...
    public static String postDataByUTF8(String url, Map data) {
        return postData(url, data, "UTF-8", "POST","UTF-8");
    }
    ...
    public static String postJSONData(String url, Map data, String defaultEncoding){
        JSONObject jsonObject = new JSONObject(data);
        try {
            PostMethod postMethod = new PostMethod(url);
            postMethod.addRequestHeader("Content-Type","application/json; charset=" + defaultEncoding);
//            SysLogUtils.debug("请求报文体requestBody:"+jsonObject.toString());
            postMethod.setRequestBody(jsonObject.toString());
            String resp = sendHttpMethod(postMethod, defaultEncoding);
